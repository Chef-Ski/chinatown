  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-stone-50 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-md border border-stone-200">
        <h1 className="text-3xl font-bold text-center mb-6 text-[#D13523]">Log In</h1>
        ...
        <div className="mt-4 flex justify-between items-center">
          <a href="/auth/forgot" className="text-sm text-[#D13523] hover:underline">Forgot Password?</a>
          <div className="text-sm text-stone-700">
            Don't have an account?{" "}
            <a href="/auth/signup" className="text-[#D13523] hover:underline">Sign Up</a>
          </div>
        </div>
      </div>
    </div>
