    ...
    <div>
      ...
      <div className="flex flex-row items-center justify-center gap-x-8 mt-96 px-12">
        <div className="flex flex-col items-start text-5xl font-bold max-w-2xl">
          ...
          <a href="#_" className="relative inline-flex mt-8 items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-2xl text-black transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
