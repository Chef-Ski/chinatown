...
const MeetTheTeamSection = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Computer science educator with a focus on making coding accessible to beginners.",
      image: "/api/placeholder/300/300" // Replace with actual image path
    },
    {
      name: "Alex Thompson",
    ...
    <section ref={sectionRef} className="py-24 bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="container mx-auto px-4 md:px-12">
        <div ref={headingRef} className="text-center mb-16">
          ...
          <div className="h-1 w-24 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full mx-auto mb-6"></div>
