...
const Navbar = () => {
    return (
        <div className='w-full absolute top-4  flex justify-center'>
            <ul className='flex flex-row items-center px-12 justify-between border backdrop-blur-lg w-[1200px] border-black rounded-2xl'>
                ...
                <div className='flex flex-row items-center gap-x-6 text-xl text-black'>
                    <a href=""><li className='border-2 border-black rounded-2xl px-8 py-2  hover:bg-gray-300'>Login</li></a>
